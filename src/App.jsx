...
// ─── DATA SEED ──────────────────────────────────────────────────────
const INIT_PROPS = [
  { id:1, name:'Apto 301 - Ed. Mirador',    address:'Calle 50 #30-20, Medellín',   rent:1800000, tenant:'Carlos Rodríguez', phone:'310-111-2222', status:'active',  due:1,  paid:true,  deposit:3600000, start:'2024-03-01', end:'2025-03-01', area:'65m²',  rooms:2, type:'Apartamento', baths:2 },
  { id:2, name:'Casa 45 - Laureles',         address:'Carrera 76 #45-10, Medellín', rent:2500000, tenant:'Ana García',       phone:'310-333-4444', status:'active',  due:5,  paid:false, deposit:5000000, start:'2023-08-01', end:'2025-08-01', area:'120m²', rooms:3, type:'Casa',         baths:3 },
  ...
  { id:4, name:'Apto 502 - Torres Norte',    address:'Calle 80 #20-15, Medellín',   rent:1600000, tenant:'María Torres',     phone:'310-777-8888', status:'active',  due:10, paid:true,  deposit:3200000, start:'2024-07-01', end:'2025-07-01', area:'55m²',  rooms:2, type:'Apartamento', baths:1 },
  ...
  const renderDashboard = () => {
    ...
    return (
      <div className="fade-in" style={{display:'flex', flexDirection:'column', gap:24}}>
        {/* HEADER */}
        <div>
          <div style={{fontSize:13, color:C.text3, fontWeight:500, marginBottom:6, letterSpacing:'.3px', textTransform:'uppercase'}}>RentTrack · Mayo 2025</div>
          ...
          <div style={S.card}>
            <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24}}>
              ...
              <div style={{textAlign:'right'}}>
                ...
                <div style={{fontSize:11, color:C.text3, fontWeight:600, letterSpacing:'.3px', textTransform:'uppercase'}}>Mayo 2025</div>
              </div>
            </div>
